...
class ReportETL:
    ...
    def etl_cnt_27(self, from_date, to_date):
        ...
        self.exct_rep.cnt_27(cnt_27_cfg['report_name'], cnt_27_cfg['from_date'], cnt_27_cfg['to_date'])
        self.task_q.add_task(self.trns_csv.cnt_27, os.path.join(self.DWLD_DIR, cnt_27_cfg['file_name']), os.path.join(self.DWLD_DIR, cnt_27_cfg['processed_file']))
    ...
    def etl_cnt_19(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.cnt_19, os.path.join(self.DWLD_DIR, cnt_19_cfg['file_name']), os.path.join(self.DWLD_DIR,cnt_19_cfg['processed_file']))
    ...
    def etl_adj_11(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.adj_11, os.path.join(self.DWLD_DIR, adj_11_cfg['file_name']), os.path.join(self.DWLD_DIR, adj_11_cfg['processed_file']))
    ...
    def etl_fin_18(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.fin_18, os.path.join(self.DWLD_DIR, fin_18_cfg['file_name']), os.path.join(self.DWLD_DIR, fin_18_cfg['processed_file']))
    ...
    def etl_pay_41(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.pay_41, os.path.join(self.DWLD_DIR, pay_41_cfg['file_name']), os.path.join(self.DWLD_DIR, pay_41_cfg['processed_file']))
    ...
    def etl_xry_03(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.xry_03, os.path.join(self.DWLD_DIR, xry_03_cfg['file_name']), os.path.join(self.DWLD_DIR, xry_03_cfg['processed_file']))
    ...
    def etl_ccr_2(self, from_date, to_date):
        ccr2_cfg = self.rpt_config.ccr_2(from_date, to_date)
        self.exct_rep.ccr_02(ccr2_cfg['report_name'], from_date, to_date)
        self.task_q.add_task(self.trns_csv.ccr_02, os.path.join(self.DWLD_DIR, ccr2_cfg['file_name']), os.path.join(self.DWLD_DIR, ccr2_cfg['processed_file']))
    ...
    def etl_ccr_03(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.ccr_03, os.path.join(self.DWLD_DIR, ccr3_cfg['file_name']), os.path.join(self.DWLD_DIR, ccr3_cfg['processed_file']))
    ...
    def etl_per_02(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.per_02, os.path.join(self.DWLD_DIR, per_02_cfg['file_name']), os.path.join(self.DWLD_DIR, per_02_cfg['processed_file']))
    ...
    def etl_med_01(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.med_01, os.path.join(self.DWLD_DIR, med_1_cfg['file_name']), os.path.join(self.DWLD_DIR, med_1_cfg['processed_file']))
    ...
    def etl_pat_20(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.pat_20, os.path.join(self.DWLD_DIR, pat_20_cfg['file_name']), os.path.join(self.DWLD_DIR, pat_20_cfg['processed_file']))
    ...
    def etl_lab_01(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.lab_01, os.path.join(self.DWLD_DIR, lab_1_cfg['file_name']), os.path.join(self.DWLD_DIR, lab_1_cfg['processed_file']))
    ...
    def etl_cht_02(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.cht_02, os.path.join(self.DWLD_DIR, cht_2_cfg['file_name']), os.path.join(self.DWLD_DIR, cht_2_cfg['processed_file']))
    ...
    def etl_pat_02(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.pat_02, os.path.join(self.DWLD_DIR, pat_2_cfg['file_name']), os.path.join(self.DWLD_DIR, pat_2_cfg['processed_file']))
    ...
    def etl_adj_04(self, from_month, to_month):
        ...
        self.task_q.add_task(self.trns_csv.adj_4, os.path.join(self.DWLD_DIR, adj_4_cfg['file_name']), os.path.join(self.DWLD_DIR, adj_4_cfg['processed_file']))
    ...
    def etl_pay_04(self, from_date, to_date):
        pay_4_cfg = self.rpt_config.pay_4(from_date, to_date)
        self.exct_rep.pay_4(pay_4_cfg['report_name'], from_date, to_date)
        ...
        self.task_q.add_task(self.trns_csv.pay_4, os.path.join(self.DWLD_DIR, pay_4_cfg['file_name']), os.path.join(self.DWLD_DIR, pay_4_cfg['processed_file']))
    ...
    def etl_rev_16(self, from_date, to_date):
        ...
        self.task_q.add_task(self.trns_csv.rev_16, os.path.join(self.DWLD_DIR, rev_16_cfg['file_name']), os.path.join(self.DWLD_DIR, rev_16_cfg['processed_file']))
...
def execute_report_functions(client_id, mode, function_list, function_args=None):
    all_report_function_names = ["etl_cnt_27", "etl_cnt_19", "etl_adj_11", "etl_fin_18", "etl_pay_41", "etl_xry_03", "rtl_pay_10", "etl_ccr_2", "etl_ccr_03", "etl_per_02", "etl_med_01", "etl_pat_20", "etl_lab_01", "etl_cht_02", "etl_pat_02", "etl_rev_16", "etl_pay_04", "etl_adj_04"]
