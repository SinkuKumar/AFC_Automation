...
- This module contains the script for downloading CNT_27 monthly reports for Experity clients.
...
def download_report(specific_client_list: list,
    ...
    :param cnt_27_from_date: starting date
    :type cnt_27_from_date: str

    :param cnt_27_to_date: end date
    :param cnt_27_to_date: str
