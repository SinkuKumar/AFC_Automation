...
lab_1_cfg = rpt_config.lab_1()
xry_3_cfg = rpt_config.xry_3()
cht_2_cfg = rpt_config.cht_2()
med_1_cfg = rpt_config.med_1()
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, pay_41_cfg['file_name']), CLIENT_TODAY_DIR)
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, pat_2_cfg['file_name']), CLIENT_TODAY_DIR)

# Extract, Transform, Load LAB_1
exct_rep.lab_1(lab_1_cfg['report_name'], lab_1_cfg['from_date'], lab_1_cfg['to_date'])
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, lab_1_cfg['file_name']), CLIENT_TODAY_DIR)

# Extract, Transform, Load XRY_3
exct_rep.xry_3(xry_3_cfg['report_name'], xry_3_cfg['from_date'], xry_3_cfg['to_date'])
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, xry_3_cfg['file_name']), CLIENT_TODAY_DIR)

# Extract, Transform, Load CHT_2
exct_rep.cht_2(cht_2_cfg['report_name'], cht_2_cfg['from_date'], cht_2_cfg['to_date'])
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, cht_2_cfg['file_name']), CLIENT_TODAY_DIR)

# Extract, Transform, Load MED_1
exct_rep.med_1(med_1_cfg['report_name'], med_1_cfg['from_date'], med_1_cfg['to_date'])
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, med_1_cfg['file_name']), CLIENT_TODAY_DIR)

# Extract, Transform, Load PER_2
exct_rep.per_2(per_2_cfg['report_name'], per_2_cfg['from_date'], per_2_cfg['to_date'])
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, per_2_cfg['file_name']), CLIENT_TODAY_DIR)
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, pat_20_cfg['file_name']), CLIENT_TODAY_DIR)

# Extract, Transform, Load CCR_2
exct_rep.ccr_2(ccr2_cfg['report_name'], ccr2_cfg['from_date'], ccr2_cfg['to_date'])
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, ccr2_cfg['file_name']), CLIENT_TODAY_DIR)

# Extract, Transform, Load CCR_3
exct_rep.ccr_3(ccr3_cfg['report_name'], ccr3_cfg['from_date'], ccr3_cfg['to_date'])
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, ccr3_cfg['file_name']), CLIENT_TODAY_DIR)
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, rev_16_cfg['file_name']), CLIENT_TODAY_DIR)
...
# task_q.add_task(file_folder.move_file, os.path.join(DWLD_DIR, pay_4_cfg['file_name']), CLIENT_TODAY_DIR)
