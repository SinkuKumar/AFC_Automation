...
report_to_date =  '03/11/2025'   # MM/DD/YYYY format
...
def web_workflow():
    try:
        ...
        file_operation.wait_for_download('PAY_10', download_dir)
...
def data_workflow():
    ...
    try:
        ...
        input_csv_file = os.path.join(download_dir, r"PAY_10_PayerPatientPaidAdjustedByPayerClass.csv")
        output_csv_file = os.path.join(download_dir, r"PAY_10_transformed_data.csv")
...
merged_df = pl.concat(df_list, how="vertical")  # Stack them vertically

# Save the merged file
merged_df.write_csv("merged_output.csv")
