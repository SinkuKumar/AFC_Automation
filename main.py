...
try:
    ...
    # experity.sample('Financials', 'Adjustments', 'By Reason')
    experity.select_pm_report('Financials', 'Adjustments', 'ADJ 1')
    # experity.select_report('Financials', 'Adjustments', 'By Reason')

    experity.select_closing_date('ADJ 1', 'December 2024', 'August 2024')
    time.sleep(5)
