...
class UltraMsgMessages:
    ...
    def send_message(self, phone_number: int, message: str):
        ...
        return self.umsg_base.make_request(url= 'messages/chat', payload=payload, request_type='POST')
    ...
    def send_image(self, phone_number: int, image_url: str, image_caption: str):
        ...
        return self.umsg_base.make_request(url= 'messages/image', request_type='POST', payload=payload)
    ...
    def send_sticker(self, phone_number: int, sticker_url: str):
        ...
        return self.umsg_base.make_request(url= 'messages/sticker', request_type='POST', payload=payload)
    ...
    def send_document(self, phone_number: int, doc_name: str, doc_url: str, doc_caption: str):
        ...
        return self.umsg_base.make_request(url= 'messages/document', request_type='POST', payload=payload)
    ...
    def send_audio(self, phone_number: int, audio_url: str):
        ...
        return self.umsg_base.make_request(url='messages/audio', request_type="POST", payload=payload)
    ...
    def send_voicenote(self, phone_number: int, voice_url: str):
        ...
        return self.umsg_base.make_request(url = 'messages/voice', request_type="POST", payload = payload)
    ...
    def send_video(self, phone_number: int, video_url: str, video_caption: str):
        ...
        return self.umsg_base.make_request(url= 'messages/video', request_type='POST', payload=payload)
    ...
    def send_contact(self, phone_number: int, contact_id: str):
        ...
        return self.umsg_base.make_request(url = 'messages/contact', request_type="POST", payload = payload)
    ...
    def send_location(self, phone_number: int, address: str, latitude: float, longitude: float):
        ...
        return self.umsg_base.make_request(url = "messages/location", request_type="POST", payload = payload)
    ...
    def send_vcard(self, phone_number: int, text_card: str):
        ...
        return self.umsg_base.make_request(url = "messages/vcard", request_type="POST", payload = payload)
    ...
    def react_to_message(self, message_id, emoji: str):
        ...
        return self.umsg_base.make_request(url = "messages/reaction", request_type="POST", payload = payload)
    ...
    def delete_message(self, msg_id: str):
        ...
        return self.umsg_base.make_request(url = "messages/delete", payload = payload, request_type="POST")
    ...
    def resend_message_by_status(self, status: str):
        ...
        return self.umsg_base.make_request(url = "messages/resendByStatus", payload = payload, request_type="POST")
    ...
    def resend_message_by_id(self, id: int):
        ...
        '''
        payload = f"id={id}"
        return self.umsg_base.make_request(url = "resendById", payload = payload, request_type="POST")
    ...
    def delete_message_from_instance(self, status: str):
        ...
        '''
        payload = f"status={status}"
        return self.umsg_base.make_request(url = "messages/clear", request_type="POST", payload = payload)
...
if __name__ == '__main__':
    ...
    """
    print(f"Send video: {um_msgs.send_video(phone_number, 'https://file-example.s3-accelerate.amazonaws.com/video/test.mp4', 'This is a sample video.')}")
    print(f"Send contact{um_msgs.send_contact(phone_number, '911234567890@c.us')}")
    send_loc_resp = um_msgs.send_location(phone_number, 'Office building \nBangalore', 12.918, 77.564)
    ...
    # react_resp = um_msgs.react_to_message('true_phone_number@c.us_3EB09D4D6989D6BDC6E85C', '👍')     
    # print(react_resp)
    # # NOTE: Delete message not working from Ultramsg
    # del_resp = um_msgs.delete_message('true_phone_number@c.us_3EB09D4D6989D6BDC6E85C')
    # print(del_resp)